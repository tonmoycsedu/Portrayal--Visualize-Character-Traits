class Adjective extends Card {
    ...
    highlight_word(){
        ...
        if(self.selected_mentions.length){
            ...
            ED.quill.formatText(d.adjective_idx[0], d.adjective_idx[1] - d.adjective_idx[0], {
                'bold': true,
    ...
    wordzone(dataSet){
        var self = this
        d3.selectAll(".word_adjective").remove()
        ...
        let words = self.svg.g.selectAll('.word')
            ...
            .attr("class", "word word_adjective")
